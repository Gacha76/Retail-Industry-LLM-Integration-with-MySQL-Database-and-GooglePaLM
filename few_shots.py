...
group by t_shirt_id) a left join discounts on a.t_shirt_id = discounts.t_shirt_id
 """,
     'SQLResult': "Result of the SQL query",
     'Answer' : "5742"},
    {"Answer": "'XS', 23, 'S', 15, 'M', 61, 'L', 33",
     "Question": "How many white color Levi's t shirts we have available for each size?",
     'SQLQuery': "SELECT size, stock_quantity from t_shirts where brand = 'Levi' and color = 'White'\n ",
     'SQLResult': 'Result of the SQL query'
    }
]
